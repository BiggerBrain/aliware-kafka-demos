...
/**
 * java -cp *:kafka-vpc-demo.jar tool.connect.ConnectorCheckContainsJgwIpHk
 */
public class ConnectorCheckContainsJgwIpHk {
...
//        clusterInfoList.add(new ConnectorClusterInfo("bj1","9.144.115.193","9.144.32.56:10887"));
        clusterInfoList.add(new ConnectorClusterInfo("hk", "127.0.0.1", "9.62.228.131:10729"));
